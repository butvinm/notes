...
5. When the user acts on an unread reminder or promise, offer `notes read <id>`; showing a note never marks it read. When nothing matches, say so and offer `/notes:capture` to record what the user tells you now.
